...
const Contact = () => {
  return (
    ...
    <form className=' w-full flex justify-center items-center space-y-9 flex-col'>
       ...
       <input className='outline-none text-black py-2 px-4 rounded' id='name'/></div>
       <div className='flex flex-col space-y-2'> <label htmlFor="email">Email</label>
       <input className='outline-none text-black py-2 px-4 rounded' id='email'/></div> <div className='flex flex-col space-y-2'> <label htmlFor="msg">Message</label>
       <textarea id='msg' className='outline-none text-black py-2 px-4 rounded' cols={25} rows={4}> </textarea>
    </div>
