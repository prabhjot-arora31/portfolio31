    ...
    <div className='flex pb-5 justify-center flex-wrap space-y-10 items-center'>
        ...
        <div>
            ...
            <div className='mb-5 flex space-x-4'>
                <Link href='https://linkedin.com/in/prabhjot-arora' className='hover:bg-[#0895A1] hover:text-[#20242D] text-[#0895A1]' style={{borderRadius:"50%",border:'1px solid #0895A1',width:'40px',height:'40px'}}><i className="fa-brands fa-linkedin-in"  ></i></Link>
