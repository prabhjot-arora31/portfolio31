    ...
    <div className='flex pb-5 justify-center flex-wrap space-y-10 items-center'>
        ...
        <div>
            ...
            <div className='mb-5 flex space-x-4'>
                ...
                <Link href='https://github.com/prabhjot-arora31' className='hover:bg-[#0895A1] flex justify-center items-center hover:text-[#20242D] text-[#0895A1]' style={{borderRadius:"50%",border:'1px solid #0895A1',width:'40px',height:'40px'}}><i className="fa-brands fa-github"  ></i></Link>
                </div>
