    ...
    <div className='flex px-10 pb-5 justify-center space-x-14 flex-wrap space-y-10 items-center'>
        ...
        <div>
            ...
            <div className='mb-5 flex space-x-4'>
                <Button className='hover:bg-[#0895A1] hover:text-[#20242D] text-[#0895A1]' style={{borderRadius:"50%",border:'1px solid #0895A1',width:'40px',height:'40px'}}><i class="fa-brands fa-linkedin-in"  ></i></Button>
                <Button className='hover:bg-[#0895A1] hover:text-[#20242D] text-[#0895A1]' style={{borderRadius:"50%",border:'1px solid #0895A1',width:'40px',height:'40px'}}><i class="fa-brands fa-instagram"  ></i></Button>
                <Button className='hover:bg-[#0895A1] hover:text-[#20242D] text-[#0895A1]' style={{borderRadius:"50%",border:'1px solid #0895A1',width:'40px',height:'40px'}}><i class="fa-brands fa-github"  ></i></Button>
                </div>
